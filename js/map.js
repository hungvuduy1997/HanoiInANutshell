...
// Declare global export references
export let map = null;
let lightMap = null;
let darkMap = null;
...
export function initMap() {
  if (map) return map; // Prevent duplicate initialization
  ...
  satelliteMap = L.tileLayer('https://mt{s}.google.com/vt/lyrs=s&x={x}&y={y}&z={z}', {
    subdomains: ['0', '1', '2', '3'],
...
// Attach control UI and Map event listeners
function setupEventListeners() {
  ...
  map.on('locationfound', (e) => {
    ...
    window.userLocationMarker = L.layerGroup([
